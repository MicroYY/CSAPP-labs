...
00000000004019a7 <addval_219>:
  4019a7:	8d 87 51 73 58 90    	lea    -0x6fa78caf(%rdi),%eax   # 4.1/5.3 popq %rax
  4019ad:	c3                   	retq   
...
00000000004019c3 <setval_426>:
  4019c3:	c7 07 48 89 c7 90    	movl   $0x90c78948,(%rdi)        # 4.2/5.2/5.8 movq %rax,%rdi
  4019c9:	c3                   	retq   
...
00000000004019d6 <add_xy>:
  4019d6:	48 8d 04 37          	lea    (%rdi,%rsi,1),%rax        # 5.7
  4019da:	c3                   	retq   

00000000004019db <getval_481>:
  4019db:	b8 5c 89 c2 90       	mov    $0x90c2895c,%eax          # 5.4 movl %eax,%edx
  4019e0:	c3                   	retq   
...
00000000004019e8 <addval_113>:
  4019e8:	8d 87 89 ce 78 c9    	lea    -0x36873177(%rdi),%eax     # 5.6 movl %ecx,%esi
  4019ee:	c3                   	retq   
...
0000000000401a03 <addval_190>:
  401a03:	8d 87 41 48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax      # 5.1 movq %rsp,%rax
  401a09:	c3                   	retq   
...
0000000000401a6e <setval_167>:
  401a6e:	c7 07 89 d1 91 c3    	movl   $0xc391d189,(%rdi)        # 5.5 movl %edx,%ecx
  401a74:	c3                   	retq   
